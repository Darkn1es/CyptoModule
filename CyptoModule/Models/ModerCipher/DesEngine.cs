...
namespace CyptoModule.Models.DES
{
    public class DesEngine : IBlockCipher
    {
            ...
            ICipherParameters parameters)
        {
            ...
            ByteKey = new KeyParameter(( (KeyParameter)parameters ).GetKey().ToArray());
        ...
        public KeyParameter ByteKey { get; private set; }
        ...
        private readonly short[] bytebit =
        {
            128, 64, 32, 16, 8, 4, 2, 1
        };

        private readonly int[] bigbyte =
        {
        ...
        private readonly byte[] totrot =
        {
            1, 2, 4, 6, 8, 10, 12, 14,
            15, 17, 19, 21, 23, 25, 27, 28
        };

        private readonly byte[] pc2 =
        {
